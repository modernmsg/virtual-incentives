    ...
    describe "(#{variant})" do
      ...
      context 'requests' do
        it 'parses JSON for a successful request' do
          stub_request(:post, "https://rest.virtualincentives.com/v4/json/orders").to_return(
            status: 200,
            body: '{}'
          )

          json = api.place_order
        ...
        it 'parses JSON for a client error' do
          ...
          stub_request(:post, "https://rest.virtualincentives.com/v4/json/orders").to_return(
            status: status,
            body: '{"order":{"errors":{"error":{"code":"90","field":"clientid","message":"Duplicate Client Id"}}}}'
          )

          json = api.place_order

          expect(json['status']).to eql status
          expect(json['order']).to have_key 'errors'
        end
        ...
        it 'creates JSON for a server error' do
          ...
          HTML
          stub_request(:post, "https://rest.virtualincentives.com/v4/json/orders").
            to_return(status: status, body: body)

          json = api.place_order

          expect(json['status']).to eql status
          expect(json.dig('error', 'message')).to eql body
        end
      end
      ...
      describe '#order' do
        it 'should gather order information' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/orders/24681234').
      ...
      describe '#orders' do
        it 'lists all orders' do
          stub_request(:get, "https://rest.virtualincentives.com/v4/json/orders").
      ...
      describe '#product' do
        it 'should gather product information' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/products/UVC-V-A03').
      ...
      describe '#product_faceplate' do
        it 'should gather face plate' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/products/UVC-V-A03/faceplate').
      ...
      describe '#product_marketing' do
        it 'should gather product marketing information' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/products/UVC-V-A03/marketing').
      ...
      describe '#product_terms' do
        it 'should gather product terms' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/products/UVC-V-A03/terms').
      ...
      describe '#products' do
        it 'should gather all products' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/products').
      ...
      describe '#balances' do
        it 'should gather balances' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/balances').
      ...
      describe '#program_balances' do
        it 'should gather program balances' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/balances/programs').
      ...
      describe '#program_products' do
        it 'should gather program products' do
          stub_request(:get, 'https://rest.virtualincentives.com/v4/json/programs/1/products').
            to_return(status: 200, body: '{"products": [{"name": " Virtual Visa® Reward (US), 3-Month","sku": "UVC-V-A03","currency": "USD","denomination": {"range": [{"min": 5,"max": 2000}]},"base-url": "","redemptions": []},{"name": " Virtual Visa® Reward (US), 6-Month","sku": "UVC-V-A06","currency": "USD","denomination": {"range": [{"min": 5,"max": 2000}]},"base-url": "","redemptions": []}]}')
      ...
      describe '#program_balance' do
        it 'should gather program balance' do
          stub_request(:get,'https://rest.virtualincentives.com/v4/json/balances/programs/26209').
      ...
      describe '#program_product' do
        it 'should gather program product' do
          stub_request(:get,'https://rest.virtualincentives.com/v4/json/programs/26209/products/UVC-V-A03').
            to_return(status: 200, body: '{"product":{"name": " Virtual Visa® Reward (US), 3-Month","sku": "UVC-V-A03","currency": "USD","denomination": {"range": [{"min": 5,"max": 2000}]},"base-url": "","redemptions": []}}')
